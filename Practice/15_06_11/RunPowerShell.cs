...
namespace UnitTestTL
{
    ...
    class RunPowerShell
    {
        static void Main(string[] args)
        {
            ...
            ps.Add("Set-ExecutionPolicy ByPass");//先执行启动安全策略，，使系统可以执行powershell脚本文件   
            ...
            PowerShell.RunScript(ps, new List<PSParam>() { par });
    ...
    //把此脚本存在此程序的bin\debug目录下。文件名为：ps.ps1，，就可以执行程序看结果：
